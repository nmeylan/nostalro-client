...
wavelet transform coded with the range coder above. This is the [RAD Bink texture]([https://en.wikipedia.org/wiki/Bink_Video](https://web.archive.org/web/20000824152455/http://www.radgametools.com/binkhCWB.htm))
