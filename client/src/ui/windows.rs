...
pub(crate) const REGISTRY: &[(WidgetId, Dispatch)] = &[
    (BASIC_INFO_WINDOW_ID, Dispatch::Trait(|w| &mut w.basic_info_window as &mut dyn InGameWindow)),
    (CHAT_WINDOW_ID, Dispatch::Trait(|w| &mut w.chat_window as &mut dyn InGameWindow)),
    (INV_WINDOW_ID, Dispatch::Trait(|w| &mut w.inventory_window as &mut dyn InGameWindow)),
    (CART_WINDOW_ID, Dispatch::Trait(|w| &mut w.cart_window as &mut dyn InGameWindow)),
    (STORAGE_WINDOW_ID, Dispatch::Trait(|w| &mut w.storage_window as &mut dyn InGameWindow)),
    (TRADE_WINDOW_ID, Dispatch::Trait(|w| &mut w.trade_window as &mut dyn InGameWindow)),
    (MAILBOX_WINDOW_ID, Dispatch::Trait(|w| &mut w.mailbox_window as &mut dyn InGameWindow)),
    (READ_MAIL_WINDOW_ID, Dispatch::Trait(|w| &mut w.read_mail_window as &mut dyn InGameWindow)),
    (CART_SELECT_WINDOW_ID, Dispatch::Trait(|w| &mut w.cart_select_window as &mut dyn InGameWindow)),
    (MAKE_ITEM_WINDOW_ID, Dispatch::Trait(|w| &mut w.make_item_window as &mut dyn InGameWindow)),
    (VENDING_SHOP_WINDOW_ID, Dispatch::Trait(|w| &mut w.vending_shop_window as &mut dyn InGameWindow)),
    (VENDING_SETUP_WINDOW_ID, Dispatch::Trait(|w| &mut w.vending_setup_window as &mut dyn InGameWindow)),
    (VENDING_AVAILABLE_WINDOW_ID, Dispatch::VendingAvailable),
    (MY_SHOP_WINDOW_ID, Dispatch::Trait(|w| &mut w.my_shop_window as &mut dyn InGameWindow)),
    (EQ_WINDOW_ID, Dispatch::Trait(|w| &mut w.equipment_window as &mut dyn InGameWindow)),
    (SKILL_WINDOW_ID, Dispatch::Trait(|w| &mut w.skill_tree_window as &mut dyn InGameWindow)),
    (STATUS_WINDOW_ID, Dispatch::Trait(|w| &mut w.status_window as &mut dyn InGameWindow)),
    (PARTY_FRIENDS_WINDOW_ID, Dispatch::Trait(|w| &mut w.party_friends_window as &mut dyn InGameWindow)),
    (GUILD_WINDOW_ID, Dispatch::Trait(|w| &mut w.guild_window as &mut dyn InGameWindow)),
    (EMBLEM_PICKER_WINDOW_ID, Dispatch::Trait(|w| &mut w.emblem_picker_window as &mut dyn InGameWindow)),
    (PARTY_HELPER_WINDOW_ID, Dispatch::Trait(|w| &mut w.party_helper_window as &mut dyn InGameWindow)),
    (HOMUN_WINDOW_ID, Dispatch::Trait(|w| &mut w.homunculus_window as &mut dyn InGameWindow)),
    (MERCENARY_WINDOW_ID, Dispatch::Trait(|w| &mut w.mercenary_window as &mut dyn InGameWindow)),
    (PET_WINDOW_ID, Dispatch::Trait(|w| &mut w.pet_window as &mut dyn InGameWindow)),
    (MERCENARY_SKILL_WINDOW_ID, Dispatch::Trait(|w| &mut w.mercenary_skill_window as &mut dyn InGameWindow)),
    (HOMUN_SKILL_WINDOW_ID, Dispatch::Trait(|w| &mut w.homun_skill_window as &mut dyn InGameWindow)),
    (BOOK_WINDOW_ID, Dispatch::Trait(|w| &mut w.book_window as &mut dyn InGameWindow)),
    (SOUND_OPTIONS_WINDOW_ID, Dispatch::Trait(|w| &mut w.sound_options as &mut dyn InGameWindow)),
    (GRAPHIC_OPTIONS_WINDOW_ID, Dispatch::Trait(|w| &mut w.graphic_options as &mut dyn InGameWindow)),
    (HOTKEY_CONFIG_WINDOW_ID, Dispatch::Trait(|w| &mut w.hotkey_config_window as &mut dyn InGameWindow)),
    (COMPANION_AI_CONFIG_WINDOW_ID, Dispatch::Trait(|w| &mut w.companion_ai_config_window as &mut dyn InGameWindow)),
    (CHAT_ROOM_CREATE_WINDOW_ID, Dispatch::Trait(|w| &mut w.chat_room_create_window as &mut dyn InGameWindow)),
    (CHAT_ROOM_MEMBER_WINDOW_ID, Dispatch::Trait(|w| &mut w.chat_room_member_window as &mut dyn InGameWindow)),
    (EMOTION_WINDOW_ID, Dispatch::Trait(|w| &mut w.emotion_window as &mut dyn InGameWindow)),
    (SHORTCUT_LIST_WINDOW_ID, Dispatch::Trait(|w| &mut w.shortcut_list_window as &mut dyn InGameWindow)),
    (QUEST_WINDOW_ID, Dispatch::Trait(|w| &mut w.quest_window as &mut dyn InGameWindow)),
    (QUEST_DETAIL_WINDOW_ID, Dispatch::Trait(|w| &mut w.quest_detail_window as &mut dyn InGameWindow)),
];
