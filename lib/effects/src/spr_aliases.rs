...
pub fn spr_def(id: EffectId) -> Option<SprDef> {
    Some(match id {
        ...
        EffectId::TrapDefault => SprDef::new("data/sprite/이팩트/기본트랩"),
        EffectId::TrapYellow => SprDef::new("data/sprite/이팩트/담황색트랩"),
        EffectId::TrapBlue => SprDef::new("data/sprite/이팩트/암청색트랩"),
        EffectId::TrapRed => SprDef::new("data/sprite/이팩트/자홍색트랩"),
        EffectId::TrapGreen => SprDef::new("data/sprite/이팩트/청록색트랩"),
