...
//! dominant original-game radial billboard pattern (Heal, Wind, Defender,
...
//! continuous ribbon strip, as the original game's casting rings
//! show: one tangent quad `(prev_bot, this_bot, this_top,
