    ...
    fn make_characters() -> Vec<CharacterInfo> {
        vec![
            CharacterInfo {
                ...
                str: 50, agi: 30, vit: 40, int: 10, dex: 20, luk: 10, effect_state: 0,
            },
            CharacterInfo {
                ...
                str: 10, agi: 15, vit: 15, int: 60, dex: 40, luk: 5, effect_state: 0,
            },
            CharacterInfo {
                ...
                str: 20, agi: 60, vit: 20, int: 15, dex: 55, luk: 30, effect_state: 0,
            },
        ]
    }
