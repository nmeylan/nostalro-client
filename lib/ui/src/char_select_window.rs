...
impl CharSelectWindow {
    ...
    fn build_fallback(&mut self, ui: &mut UiFrame, events: &mut Vec<GameEvent>) {
        ...
        let win_h = title_h + list_h + padding + detail_h + padding + FALLBACK_BTN_H + padding;
    ...
    fn make_characters() -> Vec<CharacterInfo> {
        vec![
            CharacterInfo {
                ...
                map: "prontera".into(), slot: 0, head: 1, hair_color: 0, sex: 1,
            ...
            CharacterInfo {
                ...
                map: "geffen".into(), slot: 1, head: 2, hair_color: 1, sex: 0,
            ...
            CharacterInfo {
                ...
                map: "payon".into(), slot: 2, head: 3, hair_color: 2, sex: 1,
